...
app.config(function($routeProvider) {
	...
	.when("/safety-awards", {
        templateUrl : "<?php echo base_url();?>dashboard/safety_awards"
    })
	.when("/health-wellness", {
        templateUrl : "<?php echo base_url();?>dashboard/health_wellness"
    })
	.when("/safety-boot", {
        templateUrl : "<?php echo base_url();?>dashboard/safety_boot"
    })
	.when("/personnel-training", {
        templateUrl : "<?php echo base_url();?>dashboard/training"
    })
	.when("/addtraining", {
        templateUrl : "<?php echo base_url();?>dashboard/addtraining"
    })
	.when("/users", {
