	   ...
	   for($m=1; $m<=12; ++$m)
	   {
     	 ...
     	 if($update)
	      {
			  ...
			  if($yr!=2019)
			  {
				  ...
				  $carr = $this->db->query("select * from `safety_awards` WHERE 
             ...
             <div class="row">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" name="current_year_points" class="form-control"
                        value="<?php $tsum = (($tamt+$result) - ($samt+$pamt)); if($tsum > 360) { echo '360';} else { echo $tsum;}?>" 
			 ...
			 <td><input onfocus="(this.type='date')" placeholder='' class="dtx"  value="<?=$value->used_date?>" name="used_date<?=$value->month;?>" style="text-align:center;" /></td>
                 <td><input type="text" value="<?php echo $value->point_used_for;?>" name="point_used_for<?=$value->month;?>" /></td>
					...
					<?php
					 ...
					 ?>
                      <tr>
                         ...
                         <td style="text-align:right;"><?php echo $value->point_used;?>&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="right">
                      <div>
                       <input type="text" value="<?php $bsum = (($tamt+$result) - ($samt+$pamt)); if($bsum > 360) { echo '360';} else { echo $bsum;}?>" 
                       name="balance" style="text-align:right;"/>
                       </div>
                      </td>
                      <td>&nbsp;</td>
