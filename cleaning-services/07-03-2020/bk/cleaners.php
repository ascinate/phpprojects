       ...
       foreach ($query->result() as $row)
       {
        ?>
            <tr>
              ...
              <td><?=$row->phone;?></td>
              <td align="left">
                <a href="<?php echo base_url();?>dashboard/editcleaner/<?=$row->id;?>" title="experience"><i class="fa fa-history"></i></a> &nbsp; &nbsp;
                <a href="<?php echo base_url();?>dashboard/editcleaner/<?=$row->id;?>" title="availability"><i class="fa fa-calendar"></i></a> &nbsp; &nbsp;
